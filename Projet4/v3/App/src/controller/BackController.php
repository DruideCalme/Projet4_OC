...
class BackController extends Controller
{
        ...
        if ($this->checkAdmin()) {
            ...
            if ($post->get('submit')) {
                ...
                if (!$errors) {
                    ...
                    $this->session->set('add_article', 'Le nouveau chapitre à bien été ajouté');
        ...
        if ($this->checkAdmin()){
            ...
            if ($post->get('submit')) {
                ...
                if (!$errors) {
                    ...
                    $this->session->set('edit_article', 'Le chapitre à bien été mis à jour');
                    header('Location: ../public/index.php?route=manageArticles');
                } else {
    ...
    public function deleteArticle($articleId)
    {
        if ($this->checkAdmin()) {
            ...
            $this->session->set('delete_article', 'Chapitre supprimé avec succès');
            header('Location: ../public/index.php?route=manageArticles');
        }
    }
        ...
        if ($this->checkLoggedIn() && $commentAuthor === $this->session->getUserInfo('pseudo')) {
            ...
            if ($post->get('submit')) {
                ...
                if (!$errors) {
                    ...
                    $this->session->set('edit_comment', 'Modification du commentaire effectuée');
    ...
    public function unflagComment($commentId)
    {
        if ($this->checkAdmin()) {
            ...
            $this->session->set('unflag_comment', 'Le commentaire a bien été autorisé');
            header('Location: ../public/index.php?route=manageComments');
        } else {
            header('Location: ../public/index.php?route=espacePerso');
        }
